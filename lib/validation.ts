...
export const PatientFormValidation = z.object({
  ...
  emergancyContactName: z
    ...
    .max(40, "Contact name must be at most 40 characters"),
  emergancyContactNumber: z
    .string()
    .refine(
  ...
  insuranceProvider: z
    .string()
    .min(3, "Insurance name must be at least 3 characters")
    .max(40, "Insurance name must be at most 40 characters"),
